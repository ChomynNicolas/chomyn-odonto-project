...
export function PacientePeek({
  ...
  return (
    <HoverCard openDelay={150} closeDelay={100} onOpenChange={(o) => { setOpen(o); if (o) void load(); }}>
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex items-start justify-between">
        ...
        <Badge variant={d.estaActivo ? "default" : "outline"} className={cn("text-xs", d.estaActivo ? "" : "opacity-70")}>
