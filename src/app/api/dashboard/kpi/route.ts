...
import { requireSessionWithRoles } from "../../_lib/auth"; // ajusta ruta si difiere

export const dynamic = "force-dynamic"; // o usa revalidate si prefieres cache estática por X seg.
...
export async function GET(req: NextRequest) {
  ...
  try {
    const role = (auth.session.user as any)?.rolNombre as "RECEP"|"ODONT"|"ADMIN" ?? "RECEP";
